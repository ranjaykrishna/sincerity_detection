...
\bibitem{scherer2000}Scherer, K.R., ``Psychological models of emotion. In: Borod, J. (Ed.), The Neuropsychology of Emotion`` in Oxford University Press, pp. 137Ð162, 2000

\bibitem{scherer2003}Scherer, K.R., ``Vocal communication of emotion: a review of research paradigms`` in Speech Communication 40 (1Ð2), 227Ð256, 2003

\bibitem{pennebaker}Pennebaker, J. W., Booth, R., Francis, M., ``Linguistic inquiry and word count: LIWC2007`` Ð operatorÕs manual. Tech. rep., University of Texas, 2007
...
\bibitem{ranganath}Ranganath, R., Jurafsky, D., McFarland, D. ``It's Not You, It's Me'', in Proceedings of the 2009 Conference on Empirical Methods in Natural Language Processing, 2009

\bibitem{lee} Lee, C., Narayanan, S. and Pieraccini, R. ``Combining acoustic and language information for emotion recognition``, in INTERSPEECH, 2002

\bibitem{ang} Ang, J. , et al. ``Prosody-based automatic detection of annoyance and frustration in human-computer dialog`` in INTERSPEECH, 2002

\bibitem{men} Menninghaus, W., et al. ``Sounds funny? Humor effects of phonological and prosodic figures of speech`` in Psychology of Aesthetics, Creativity, and the Arts 8.1 : 71, 2014

\bibitem{pur} Purandare, A., and Litman, D. ``Humor: Prosody analysis and automatic recognition for f* r* i* e* n* d* s*`` in Proceedings of the 2006 Conference on Empirical Methods in Natural Language Processing. Association for Computational Linguistics, 2006

\bibitem{fein} Feinberg, David R., Jones, B. Little, A., D. Michael Burt, and Perrett, D.,``Manipulations of Fundamental and Formant Frequencies In¿uence the Attractiveness of Human Male Voices`` in Animal Behaviour 69 pp: 561-568, 2005

\bibitem{Mair} Mairesse, F.  et al. ``Using Linguistic Cues for the Automatic Recognition of Personality in Conversation and Text`` in J. Artif. Intell. Res.(JAIR) 30: 457-500, 2007

\bibitem{Grav} Gravano, A., et al., ``Acoustic and prosodic correlates of social behavior``, 2011
